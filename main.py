...
boss = os.path.join(os.path.dirname(__file__), 'images/boss')
player = os.path.join(os.path.dirname(__file__), 'images/player')
powerups = os.path.join(os.path.dirname(__file__), 'images/powerups')
...
pygame.display.set_caption('Ablation')
clock = pygame.time.Clock()

# Background
background = pygame.image.load(os.path.join(images, 'SpaceBackground.png')).convert()
scale_background = pygame.transform.scale(background, (650, 650))

# Load Images
level_complete = pygame.image.load(os.path.join(images, 'level_complete.png')).convert()
level_complete.set_colorkey(black)
paused_img = pygame.image.load(os.path.join(images, 'paused.png')).convert()
paused_img.set_colorkey(black)
boss1_text = pygame.image.load(os.path.join(boss, 'boss1_text.png')).convert()
boss1_text.set_colorkey(black)
final_boss_text = pygame.image.load(os.path.join(boss, 'final_boss_text.png')).convert()
final_boss_text.set_colorkey(black)
boss_defeated_text = pygame.image.load(os.path.join(boss, 'boss_defeated_text.png')).convert()
boss_defeated_text.set_colorkey(black)
game_complete = pygame.image.load(os.path.join(images, 'game_complete.png')).convert()
game_complete.set_colorkey(black)
you_win = pygame.image.load(os.path.join(images, 'you_win.png')).convert()
you_win.set_colorkey(black)
high_scores_text = pygame.image.load(os.path.join(images, 'high_scores.png')).convert()
high_scores_text.set_colorkey(black)
high_scores_box = pygame.image.load(os.path.join(images, 'high_scores_box.png')).convert()
high_scores_box.set_colorkey(black)
enter_name_box = pygame.image.load(os.path.join(images, 'enter_name_box.png')).convert()
enter_name_box.set_colorkey(black)
continue_text = pygame.image.load(os.path.join(images, 'continue.png')).convert()
continue_text_scale = pygame.transform.scale(continue_text, (360, 30))
continue_text_scale.set_colorkey(black)
boss1_bullet = pygame.image.load(os.path.join(boss, 'boss1_bullet.png')).convert()
boss1_laser = pygame.image.load(os.path.join(boss, 'boss1_laser.png')).convert()
boss1_laser.set_colorkey(black)
boss1_laser_warming = pygame.image.load(os.path.join(boss, 'boss1_laser_warming.png')).convert()
boss1_laser_warming.set_colorkey(black)
boss2_missile = pygame.image.load(os.path.join(boss, 'boss2_missile.png')).convert()
boss2_missile_scale = pygame.transform.scale(boss2_missile, (45, 45))
boss2_missile_scale.set_colorkey(black)
boss3_exhaust = pygame.image.load(os.path.join(boss, 'boss3_exhaust.png')).convert()
boss3_exhaust.set_colorkey(black)
boss3_laser = pygame.image.load(os.path.join(boss, 'boss3_laser.png')).convert()
boss3_laser_warming = pygame.image.load(os.path.join(boss, 'boss3_laser_warming.png')).convert()
boss5_laser = pygame.image.load(os.path.join(boss, 'boss5_laser.png')).convert()
...
game_over_img = pygame.image.load(os.path.join(images, 'game_over_img.png')).convert()
scale_game_over_img = pygame.transform.scale(game_over_img, (389, 550))
scale_game_over_img.set_colorkey(black)
player_img = pygame.image.load(os.path.join(player, 'player.png')).convert()
player_exhaust = pygame.image.load(os.path.join(player, 'player_exhaust.png')).convert()
boss1_img = pygame.image.load(os.path.join(boss, 'boss_1.png')).convert()
boss2_img = pygame.image.load(os.path.join(boss, 'boss_2.png')).convert()
scale_boss2_img = pygame.transform.scale(boss2_img, (517, 293))
boss3_img = pygame.image.load(os.path.join(boss, 'boss_3.png')).convert()
scale_boss3_img = pygame.transform.scale(boss3_img, (290, 400))
boss4_img = pygame.image.load(os.path.join(boss, 'boss_4.png')).convert()
...
boss5_img = pygame.image.load(os.path.join(boss, 'boss_5.png')).convert()
scale_boss5_img = pygame.transform.scale(boss5_img, (575, 800))
scale_boss5_img.set_colorkey(black)
boss5_img_no_right_arm = pygame.image.load(os.path.join(boss, 'boss5_no_right_arm.png')).convert()
...
boss5_img_no_arms = pygame.image.load(os.path.join(boss, 'boss5_no_arms.png')).convert()
scale_boss5_img_no_arms = pygame.transform.scale(boss5_img_no_arms, (575, 800))
scale_boss5_img_no_arms.set_colorkey(black)
boss5_img_no_left_arm1 = pygame.image.load(os.path.join(boss, 'boss5_no_left_arm1.png')).convert()
...
boss5_img_no_arms1 = pygame.image.load(os.path.join(boss, 'boss5_no_arms1.png')).convert()
scale_boss5_img_no_arms1 = pygame.transform.scale(boss5_img_no_arms1, (575, 800))
scale_boss5_img_no_arms1.set_colorkey(black)
boss5_img_cabin_hitbox = pygame.image.load(os.path.join(boss, 'boss_5_cabin_hitbox.png')).convert()
...
boss5_img_left_hitbox = pygame.image.load(os.path.join(boss, 'boss_5_left_hitbox.png')).convert()
...
boss5_img_right_hitbox = pygame.image.load(os.path.join(boss, 'boss_5_right_hitbox.png')).convert()
...
laser1 = pygame.image.load(os.path.join(player, 'laser1.png')).convert()
laser1left = pygame.image.load(os.path.join(player, 'laser1left.png')).convert()
laser1right = pygame.image.load(os.path.join(player, 'laser1right.png')).convert()
laserult = pygame.image.load(os.path.join(player, 'laserult.png')).convert()
...
for img in meteor_list:
    meteor_images.append(pygame.image.load(os.path.join(images, os.path.join(img))).convert())
explosion_anim = {}
explosion_anim['lg'] = []
explosion_anim['sm'] = []
...
for i in range(9):
    ...
    img = pygame.image.load(os.path.join(images, os.path.join(filename))).convert()
...
powerup_images = {}
powerup_images['shield'] = pygame.image.load(os.path.join(powerups, 'shield_gold.png')).convert()
powerup_images['gun'] = pygame.image.load(os.path.join(powerups, 'pill_yellow.png')).convert()
powerup_images['damage'] = pygame.image.load(os.path.join(powerups, 'pill_red.png')).convert()
powerup_images['ult'] = pygame.image.load(os.path.join(powerups, 'pill_blue.png')).convert()
heart = pygame.image.load(os.path.join(powerups, 'heart.png')).convert()
heart.set_colorkey(black)
scale_heart = pygame.transform.scale(heart, (27, 27))

# Load Sounds
background_sound = pygame.mixer.music.load(os.path.join(sounds, 'background_music.mp3'))
pygame.mixer.music.set_volume(0.15)
level_up_sound = pygame.mixer.Sound(os.path.join(sounds, 'level_up_sound.wav'))
shoot_sound = pygame.mixer.Sound(os.path.join(sounds, 'Laser.wav'))
boss_fight_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss_fight_sound.wav'))
final_boss_fight_sound = pygame.mixer.Sound(os.path.join(sounds, 'final_boss_fight_sound.wav'))
you_win_sound = pygame.mixer.Sound(os.path.join(sounds, 'you_win_sound.wav'))
boss1_bullet_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss1_bullet_sound.wav'))
boss1_bullet_sound.set_volume(0.5)
pygame.mixer.Sound.set_volume(shoot_sound, 0.6)
boss1_warming_sound = pygame.mixer.Sound(os.path.join(sounds, 'warming_sound.wav'))
boss1_laser_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss1_laser.wav'))
boss2_missile_sound = pygame.mixer.Sound(os.path.join(sounds, 'missile.wav'))
boss2_missile_sound.set_volume(0.25)
boss3_thrust = pygame.mixer.Sound(os.path.join(sounds, 'thrust.wav'))
boss3_laser_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss3_laser_sound.wav'))
boss4_laser_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss4_laser_sound.wav'))
boss5_laser_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss5_laser_sound.wav'))
boss5_ult_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss5_ult_sound.wav'))
boss_defeated_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss_defeated.wav'))
boss_defeated_sound.set_volume(0.3)
heart_sound = pygame.mixer.Sound(os.path.join(sounds, 'jolly_laugh.wav'))
shield_sound = pygame.mixer.Sound(os.path.join(sounds, 'powerup_shield.wav'))
shield_sound.set_volume(0.75)
damage_sound = pygame.mixer.Sound(os.path.join(sounds, 'damage_sound.wav'))
ult_powerup_sound = pygame.mixer.Sound(os.path.join(sounds, 'ult_powerup_sound.wav'))
gun_sound = pygame.mixer.Sound(os.path.join(sounds, 'powerup_gun.wav'))
explosion_sound = pygame.mixer.Sound(os.path.join(sounds, 'Explosion.wav'))
pygame.mixer.Sound.set_volume(explosion_sound, 0.7)
player_die_sound = pygame.mixer.Sound(os.path.join(sounds, 'rumble1.ogg'))
ult_sound = pygame.mixer.Sound(os.path.join(sounds, 'ult_sound.wav'))
...
class Boss1(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.alive = True
        self.boss_defeated_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss_defeated.wav'))
        self.mask = pygame.mask.from_surface(self.image)
...
class Boss3(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.alive = True
        self.boss_defeated_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss_defeated.wav'))
        self.boss_thrust_sound = pygame.mixer.Sound(os.path.join(sounds, 'thrust.wav'))
...
class Boss5(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.alive = True
        self.boss_defeated_sound = pygame.mixer.Sound(os.path.join(sounds, 'boss_defeated.wav'))
        self.you_win_sound = pygame.mixer.Sound(os.path.join(sounds, 'you_win_sound.wav'))
        self.mask = pygame.mask.from_surface(self.image)
